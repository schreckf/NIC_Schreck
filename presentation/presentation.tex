...
\item Second level model: Combines predictions of different classifiers % So first we run those, then we seek to combine them by some technique
...
\frame{
\frametitle{The German Credit Dataset}
...
}
