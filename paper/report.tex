...
\lstset{    
    ...
    breaklines      =true,
    keepspaces      =false,
    deletekeywords  ={_, model, dt, set, /, rf, measures, response, log, eval, table, nrow, ncol, kappa, labels, replace, prop, cat, file, numeric, sd, median, mean, as, data, row.names, levels, all, path, predict, control, show, par, lower, upper, min, max},
    morekeywords    ={},
    numbers         =left,
    numbersep       =10pt,
    numberstyle     =\tiny,
...
%in the appendix \ref{????} or accessed 
...
\end{equation}
, whereby $P$ and $N$ denote the positive (in our case \text{good}) and negative (\textit{bad}) instances amongst the outcome values in the credit data. Further, $\hat{y}^m_j$ and $\hat{y}^m_k$ are the predictions for the positive instance $y_j$ and the prediction for the negative instance $y_k$, respectively.
...
\includegraphics[trim={1cm 2.5cm 1cm 0.63cm}, scale=0.8]{graphs/corrgram_version3.pdf}}
...
\begin{figure}[!htp] \centering{
\includegraphics[trim={0cm 0cm 0cm 0cm}, scale=0.8]{graphs/aucplot_final.pdf}}
...
\begin{algorithm}
\caption[Quantlet 3: Random Forest Model Feature Selection]{\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\large\textbf{Random Forest Model Feature Selection}}}
\end{algorithm}
...
\begin{algorithm}
\caption[Quantlet 4: Stacking: Decision Tree (level 0) Feature Selection]{\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\large\textbf{Stacking: Decision Tree (level 0) Feature Selection}}}
\end{algorithm}
\begin{lstlisting}
...
\begin{algorithm}
\caption[Quantlet 5: Logistic Regression (level 0) Feature Selection]{\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\large\textbf{Logistic Regression (level 0) Feature Selection}}}
\end{algorithm}
\begin{lstlisting}
...
\begin{algorithm}
\caption[Quantlet 6: Stacking: Neural Network (level 0) Feature Selection]{\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\large\textbf{Stacking: Neural Network (level 0) Feature Selection}}}
\end{algorithm}
\begin{lstlisting}
...
\begin{algorithm}
\caption[Quantlet 7: Gradient Boosting (level 0) Feature Selection]{\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\large\textbf{Gradient Boosting (level 0) Feature Selection}}}
\end{algorithm}
\begin{lstlisting}
...
\begin{algorithm}
\caption[Quantlet 8: Stacking: Random Forest (level 0) Feature Selection]{\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\large\textbf{Stacking: Random Forest (level 0) Feature Selection}}}
\end{algorithm}
\begin{lstlisting}
###### Feature selection for the Random Forest model. A wrapper approach #####
...
\begin{algorithm}
\caption[Quantlet 9: Random Forest Model Building]{\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\large\textbf{Random Forest Model Building}}}
\end{algorithm}
\begin{lstlisting}
############### Random forest model ###############################
...
\begin{algorithm}
\caption[Quantlet 10: Gradient Boosting Model Building]{\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\large\textbf{Gradient Boosting Model Building}}}
\end{algorithm}
\begin{lstlisting}
...
\begin{algorithm}
\caption[Quantlet 11: Stacking: Decision Tree (level 0) Model Building]{\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\large\textbf{Stacking: Decision Tree (level 0) Model Building}}}
\end{algorithm}
\begin{lstlisting}
################ Decision tree model ##############################
...
\begin{algorithm}
\caption[Quantlet 11: Stacking: Logistic Regression (level 0) Model Building]{\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\large\textbf{Stacking: Logistic Regression (level 0) Model Building}}}
\end{algorithm}
\begin{lstlisting}
###### Logit model ################################################
...
\begin{algorithm}
\caption[Quantlet 12: Stacking: Neural Network (level 0) Model Building]{\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\large\textbf{Stacking: Neural Network (level 0) Model Building}}}
\end{algorithm}
\begin{lstlisting}
###### Neural Network #############################################
...
\begin{algorithm}
\caption[Quantlet 13: Stacking: Gradient Boosting (level 0) Model Building]{\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\large\textbf{Stacking: Gradient Boosting (level 0) Model Building}}}
\end{algorithm}
\begin{lstlisting}
...
\begin{algorithm}
\caption[Quantlet 14: Stacking: Random Forest (level 0) Model Building]{\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\large\textbf{Stacking: Random Forest (level 0) Model Building}}}
\end{algorithm}
\begin{lstlisting}
...
\begin{algorithm}
\caption[Quantlet 15: Stacking: Stacked Generalization Model Building]{\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\large\textbf{Stacking: Stacked Generalization Model Building}}}
\end{algorithm}
\begin{lstlisting}
###### Stacked Generalization models ##############################
