...
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\large\textbf{B.1 Main file}}
\end{minipage}
\begin{minipage}{0.05\textwidth}
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\includegraphics[trim={0cm 0cm 0cm 0cm}, scale=0.1]{graphs/qletlogo.pdf}}
\end{minipage}
\\
\begin{lstlisting}
###################################################################
...
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\large\textbf{B.2 Gradient Boosting Model Feature Selection}}
\end{minipage}
\begin{minipage}{0.05\textwidth}
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\includegraphics[trim={0cm 0cm 0cm 0cm}, scale=0.1]{graphs/qletlogo.pdf}}
\end{minipage}
...
\begin{flushleft}
\begin{minipage}{0.94\textwidth}
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\large\textbf{B.3 Random Forest Model Feature Selection}}
\end{minipage}
\begin{minipage}{0.05\textwidth}
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\includegraphics[trim={0cm 0cm 0cm 0cm}, scale=0.1]{graphs/qletlogo.pdf}}
\end{minipage}
...
\begin{flushleft}
\begin{minipage}{0.94\textwidth}
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\large\textbf{B.4 Stacking: Decision Tree (level 0) Feature Selection}}
\end{minipage}
\begin{minipage}{0.05\textwidth}
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\includegraphics[trim={0cm 0cm 0cm 0cm}, scale=0.1]{graphs/qletlogo.pdf}}
\end{minipage}
...
\begin{flushleft}
\begin{minipage}{0.94\textwidth}
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\large\textbf{B.5 Stacking: Logistic Regression (level 0) Feature Selection}}
\end{minipage}
\begin{minipage}{0.05\textwidth}
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\includegraphics[trim={0cm 0cm 0cm 0cm}, scale=0.1]{graphs/qletlogo.pdf}}
\end{minipage}
...
\begin{flushleft}
\begin{minipage}{0.94\textwidth}
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\large\textbf{B.6 Stacking: Neural Network (level 0) Feature Selection}}
\end{minipage}
\begin{minipage}{0.05\textwidth}
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\includegraphics[trim={0cm 0cm 0cm 0cm}, scale=0.1]{graphs/qletlogo.pdf}}
\end{minipage}
...
\begin{flushleft}
\begin{minipage}{0.94\textwidth}
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\large\textbf{B.7 Stacking: Gradient Boosting (level 0) Feature Selection}}
\end{minipage}
\begin{minipage}{0.05\textwidth}
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\includegraphics[trim={0cm 0cm 0cm 0cm}, scale=0.1]{graphs/qletlogo.pdf}}
\end{minipage}
...
\begin{flushleft}
\begin{minipage}{0.94\textwidth}
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\large\textbf{B.8 Stacking: Random Forest (level 0) Feature Selection}}
\end{minipage}
\begin{minipage}{0.05\textwidth}
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\includegraphics[trim={0cm 0cm 0cm 0cm}, scale=0.1]{graphs/qletlogo.pdf}}
\end{minipage}
...
\begin{flushleft}
\begin{minipage}{0.94\textwidth}
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\large\textbf{B.9 Random Forest Model Building}}
\end{minipage}
\begin{minipage}{0.05\textwidth}
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\includegraphics[trim={0cm 0cm 0cm 0cm}, scale=0.1]{graphs/qletlogo.pdf}}
\end{minipage}
...
\begin{flushleft}
\begin{minipage}{0.94\textwidth}
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\large\textbf{B.10 Gradient Boosting Model Building}}
\end{minipage}
\begin{minipage}{0.05\textwidth}
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\includegraphics[trim={0cm 0cm 0cm 0cm}, scale=0.1]{graphs/qletlogo.pdf}}
\end{minipage}
...
\begin{flushleft}
\begin{minipage}{0.94\textwidth}
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\large\textbf{B.11 Stacking: Decision Tree (level 0) Model Building}}
\end{minipage}
\begin{minipage}{0.05\textwidth}
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\includegraphics[trim={0cm 0cm 0cm 0cm}, scale=0.1]{graphs/qletlogo.pdf}}
\end{minipage}
...
\begin{flushleft}
\begin{minipage}{0.94\textwidth}
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\large\textbf{B.12 Stacking: Logistic Regression (level 0) Model Building}}
\end{minipage}
\begin{minipage}{0.05\textwidth}
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\includegraphics[trim={0cm 0cm 0cm 0cm}, scale=0.1]{graphs/qletlogo.pdf}}
\end{minipage}
...
\begin{flushleft}
\begin{minipage}{0.94\textwidth}
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\large\textbf{B.13 Stacking: Neural Network (level 0) Model Building}}
\end{minipage}
\begin{minipage}{0.05\textwidth}
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\includegraphics[trim={0cm 0cm 0cm 0cm}, scale=0.1]{graphs/qletlogo.pdf}}
\end{minipage}
...
\begin{flushleft}
\begin{minipage}{0.94\textwidth}
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\large\textbf{B.14 Stacking: Gradient Boosting (level 0) Model Building}}
\end{minipage}
\begin{minipage}{0.05\textwidth}
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\includegraphics[trim={0cm 0cm 0cm 0cm}, scale=0.1]{graphs/qletlogo.pdf}}
\end{minipage}
...
\begin{flushleft}
\begin{minipage}{0.94\textwidth}
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\large\textbf{B.15 Stacking: Random Forest (level 0) Model Building}}
\end{minipage}
\begin{minipage}{0.05\textwidth}
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\includegraphics[trim={0cm 0cm 0cm 0cm}, scale=0.1]{graphs/qletlogo.pdf}}
\end{minipage}
...
\begin{flushleft}
\begin{minipage}{0.94\textwidth}
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\large\textbf{B.16 Stacking: Stacked Generalization Model Building}}
\end{minipage}
\begin{minipage}{0.05\textwidth}
\href{https://github.com/schreckf/NIC_Schreck/blob/master/code}{\includegraphics[trim={0cm 0cm 0cm 0cm}, scale=0.1]{graphs/qletlogo.pdf}}
\end{minipage}
